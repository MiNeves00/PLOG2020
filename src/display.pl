...
intermediateMap(
    [
        [ %Tabuleiro
            ...
            [[whiteRing | [whiteBase | [empty]]],[whiteRing | [empty]],[whiteBall | [whiteRing | [empty]]],[empty],[empty]],
            [[whiteBall | [whiteRing | [whiteBase | [empty]]]], [whiteRing | [whiteBase | [empty]]],[empty],[empty],[empty]]
        ], 
        [ %PecasDeCadaJogador
            [whiteRing],%White
